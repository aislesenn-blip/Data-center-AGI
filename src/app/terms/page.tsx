      ...
      <Section bg="white">
        <div className="max-w-3xl mx-auto prose prose-blue prose-lg">
          ...
          <div className="space-y-6 text-gray-700">
             <p>These Terms of Service constitute a legally binding agreement made between you and Ovation DOOH concerning your access to and use of our website and advertising services.</p>
