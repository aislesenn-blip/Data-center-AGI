      ...
      <Section bg="white">
        <div className="max-w-3xl mx-auto prose prose-blue prose-lg">
          ...
          <div className="space-y-6 text-gray-700">
             <p>At [Company Name], we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our advertising services.</p>
