    ...
    <main className="min-h-screen bg-[#F6F4ED] text-[#0f1115] flex flex-col font-sans">
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-12 md:py-16 space-y-12">
        ...
        <FadeIn delay={0.1} className="space-y-8 text-sm md:text-base text-zinc-500 leading-relaxed">
          <p>
            At <strong>diaspedia</strong>, we believe trust is the primary currency of cross-border financial and travel scheduling utility services. This Privacy Policy details our commitment to protecting your personal information and explaining how we collect, handle, and secure your information.
          </p>

          <div className="space-y-3">
            <h2 className="text-xl font-bold text-brand-text">1. Information We Collect</h2>
            <p>
              To organize efficient consolidated passenger ticketing, calculate optimal pricing, and manage traveler schedules, we collect standard operational information:
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc list-inside pl-4 space-y-1.5 text-xs md:text-sm">
              <li>Pooling passenger demand dynamically on specific routes to compute group savings.</li>
          ...
          <div className="space-y-3">
            ...
            <p>
              diaspedia will <strong>never</strong> rent, sell, or trade your personal information or transaction history to third-party advertisers. Your travel paths, friend networks, and calculated savings are kept strictly private within our infrastructure.
            </p>
          </div>
