    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-white text-black hover:bg-surface-200 shadow-[0_0_15px_rgba(255,255,255,0.1)]": variant === "default",
            "border border-surface-700 bg-transparent hover:bg-surface-800 text-white": variant === "outline",
            "hover:bg-surface-800 text-white": variant === "ghost",
            "bg-surface-800 text-white hover:bg-surface-700": variant === "secondary",
